...
ActiveRecord::Schema.define(version: 20180608055028) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.index ["segment_id"], name: "index_messages_on_segment_id", using: :btree
  ...
  create_table "prep_step_fours", force: :cascade do |t|
    ...
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
    t.integer  "null_votes",      default: 0
  end
  ...
  create_table "segments", force: :cascade do |t|
    ...
    t.datetime "updated_at",                null: false
    t.integer  "district_id"
    t.integer  "nominal_count", default: 0
  end
