...
RSpec.describe Preference, type: :model do
  ...
  describe "validations" do
    it {expect(create(:preference)).to be_valid}
  ...
  describe "define_enum_for" do
    ...
    #it do
      #should define_enum_for(:field_type).with_values([:text, :textarea, :number, :select_field, :checkbox, :radio, :date, :email, :password])
    #end
  end
